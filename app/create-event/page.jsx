...
export default function CreateEvent() {
  ...
  const Notification = ({ message, type }) => {
    ...
    return (
      <div
        className={`fixed top-4 left-1/2 transform -translate-x-1/2 px-4 py-3  rounded-lg shadow-md flex items-center space-x-2 ${
          type == "success"
  ...
  const handleEventCreate = async (e) => {
    ...
    const formattedTime = timeToConvert.toLocaleTimeString([], {
      hour: "2-digit",
      minute: "2-digit",
      hour12: true,
    });
    ...
    <div className="flex justify-center">
      ...
      {session ? (
        <div className="p-4 w-2/3">
          <h1 className="text-3xl font-bold max-sm:text-2xl bg-gradient-to-r from-orange-400 to-teal-600 bg-clip-text text-transparent mb-4">
            Create a New Event
          </h1>
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2">
                      <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-orange-400 sm:max-w-md box-border justify-between">
                        <span className="h-full rounded-md border-0 bg-transparent py-2 pl-2 pr-2 text-gray-500 focus:ring-2 focus:ring-inset focus:ring-orange-400 sm:text-sm">
                          $
                        </span>
                        <input
                          id="price"
                          ...
                          required
                        />
                        <span className="h-full rounded-md border-0 bg-transparent py-2 pl-2 pr-7 text-gray-500 focus:ring-2 focus:ring-inset focus:ring-orange-400 sm:text-sm">
                          USD
                        </span>
                      </div>
                    </div>
